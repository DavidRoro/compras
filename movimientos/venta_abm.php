...
//        echo $ID[0];
        ...
        try {
            ...
            //insertar cabecera 
            $cabecera = db_query(" call sp_ventas('$_POST[txtidsucursal]','$fecha','$_POST[txtfact]','$_POST[cmbtipofact]','$_POST[txtcuotas]','$_POST[txtintervalo]','PENDIENTE',0,'$_POST[txtidorden]','$_POST[txtidproveedor]','$idUsu')");
            ...
            while ($row = mysqli_fetch_array($total)) {
                ...
                db_query("update ventas set venta_cuota=$row[0] where idventas=$ID[0]");
            }
            if ($detalle) {
                echo "<script>location.href='venta_agregar.php'</script>";
            }
