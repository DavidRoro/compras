    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="asignar_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Datos de la Asignacion</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            ...
                                            ?>
                                            <label><span><i class=""></i>Ingrese Personal Asignado:</span></label>

                                            <select class="js-example-basic-single form-control" required="" name="personal">
                                                <option value="">Seleccione:</option>
                                                <?php
                                                $personal = db_query("select * from personal order by per_id");
                                                while ($fila = mysqli_fetch_array($personal)) {
                                                    ?>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Listado de Asignaciones</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                                ...
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><div align="center">Personal</div></th>                                          
                                                    ...
                                                    <?php
                                                    $consul = db_query("select * from vs_asignarff order by idasignarff");
                                                    ?>
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                ...
                                                                <td><div align="center"><button type="button" name="imprimir" id="btn-submit" class="btn btn-primary" onclick="location.href = 'ordenpago_abm.php?imprimir=imprimir&vcod=<?php echo $mostrardatos[0]; ?>'"><span class="fa fa-save"></span></button></div></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
