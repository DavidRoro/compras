...
//    $exhibicion = "";
    ...
    ///////////////////////////
    $datoscomp = db_query("select * from vs_compra where com_estado='NO UTILIZADO' OR com_estado='GENERADO' and  usu_id=$idUsu");
    ...
    $datoscomp = db_query("select * from compra where com_estado='GENERADO' and  usu_id=$idUsu");
    if ($fila = mysqli_fetch_array($datoscomp)) {
        $comprita = $fila[0];
        $factnro = $fila[3];
    } else {
    ...
    $datos3= db_query("select * from remi_compra where rem_id=$idped");
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="motivo" required="" name="cmbmotivo" onchange="tipomotivo()">  
                                                    ...
                                                    <option <?= $compra ?> value="COMPRA">COMPRA</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value="<?= $comprita ?>" type="hidden" id="txtidcompra" name="txtidcompra">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <!--<input class="form-control" value="<?//= $factnro ?>" type="text" name="txtcompra" id="idfactura">-->
                                                <input class="form-control" value="<?=$razocial?>" type="text" id="prov" name="prov" readonly="">
                                                ...
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    ...
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                <td><div align="center"><a href="notaremision_abm.php?delete=delete&id=<?php echo $mostrardatos[1] . "&id2=$mostrardatos[0]" . "&id3=$idSuc&id4=$traslados&vcanti=$mostrardatos[3]" ?>"><i class="entypo-trash"></i>Borrar</a></div></td>
