...
$consulta = db_query("SELECT * FROM vs_orden where ord_estado='PENDIENTE' and usu_id=$idUsu");
...
//    $datospresu = db_query("select * from presupuesto where usu_id=$idUsu pre_estado='GENERADO'");
//    if ($fila = mysqli_fetch_array($datospresu)) {
//        $idpresu = $fila[0];
//        $idProv = $fila[4];
////        $Prov = $fila[5];
//    }
    ...
    $datospresu = db_query("select * from vs_presu where usu_id=$idUsu and pre_estado='GENERADO'");
    if ($fila = mysqli_fetch_array($datospresu)) {
        $idpresu = $fila[0];
        $idProv = $fila[4];
        $Prov = $fila[5];
    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="orden_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> DATOS DE ORDEN COMPRA</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code> 
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>N°de Presupuesto:</span></label>

                                            <input type="text" name="txtidpresu" value="<?= $idpresu ?>" id="ids" class="form-control" readonly="">
                                    ...
                                    <!--                                    <div class="form-group">
                                                                            <div class="col-lg-9">
                                                                                ...
                                                                                <small><span class="symbol required">Haga clic aqui...</span></span> </small>
                                                                                <a href="javascript:AbrirCentrado('../buscadores/buscar_presu.php','articulo','850','350','');">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>Fecha de Orden:</span></label>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> DETALLE ORDEN COMPRA</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
<!--                                            <div>
                                                <div id="mensaje" role="alert" class="alert alert-success">INSERTO CORRECTAMENTE!!!</div>
                                            </div>-->
                                        </code>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <a href="javascript:AbrirCentrado('../buscadores/buscar_presuDet.php?vcod=<?php echo $idpresu ?>','articulo','850','350','');">
                                                    <img src="../Imagenes/anadir.png" border="0" alt="Buscar" />
                                                </a>
                                            </div>
                                        </div>
...
<!--                                                            <th><div align="center">5%</div></th>
                                                    ...
                                                    <?php
                                                    $consul = db_query("select * from vs_detorden where ord_id=$idped");
//                                                    $iva5 = 0;
//                                                    $iva10 = 0;
//                                                    $exenta = 0;
                                                    $sumar = 0;
                                                    ...
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                <td><div align="center"><a href="orden_abm.php?delete=delete&id=<?php echo $mostrardatos[1] . "&id2=$mostrardatos[0]" ?>"><i class="entypo-trash"></i>Borrar</a></div></td>
    ...
    <!--                                                                <td><div align="center"><?php //echo $mostrardatos[5]     ?></div></td> -->
                                    ...
                                    <div class="modal-footer"> 
                                        <button class="btn btn-warning" type="text" onclick="location.href = 'ordencompralistado.php'"><span class="fa fa-window-restore"></span> VOLVER</button> 
                                        <button class="btn btn-danger" type="reset"><span class="fa fa-times"></span> CANCELAR</button> 
                                        <button type="button" name="imprimir" id="btn-submit" class="btn btn-primary" onclick="location.href = 'orden_abm.php?imprimir=imprimir&vcod=<?php echo $idped; ?>'"><span class="fa fa-save"></span> IMPRIMIR</button> 
