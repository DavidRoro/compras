                ...
                <form action="conciliacion_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span>Datos de Conciliacion</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Conciliacion Bancaria</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
