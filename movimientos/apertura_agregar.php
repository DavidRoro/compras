...
//$idped = $pedido[0];
$consulta = db_query("SELECT * FROM aperturaycierre where aperturaycierre_estado='PENDIENTE' and usu_id=$idUsu");
    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="apertura_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Apertura y Cierre de Caja</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-8">
                                            <label><span><i class=""></i>Caja:</span></label>

                                            <select class="js-example-basic-single form-control" required="" name="txtidcaja">
                                                <option value="">Seleccione:</option>
                                                <?php
                                                $caja = db_query("select * from caja order by idcaja");
                                                while ($fila = mysqli_fetch_array($caja)) {
                                                    $cajas = $fila[0];
                                                    if ($idProv == $cajas) {
                                                        $vcaja = "selected";
                                                    } else {
                                                    ...
                                                    <option <?= $vcaja ?> value="<?php echo $fila[0]; ?>"> <?php echo $fila[1]; ?></option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-8">
                                            ...
                                            <select class="js-example-basic-single form-control" required="" name="cmbtipo">
                                                <option value="">Seleccione:</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>Ingrese Monto De Apertura:</span></label>

                                            <input type="number" id="montoregistro" name="montoregistro" class="form-control">
                                        </div>  
                                    </div>

                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>Ingrese Monto De Cierre:</span></label>

                                            <input type="number" id="montoregistrofinal" name="montoregistrofinal" class="form-control">
                                        </div>  
                                    </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Listado de Aperturas y Cierre de Caja</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                                ...
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><div align="center">Caja</div></th>
                                                            <th><div align="center">Monto</div></th>
                                                            <th><div align="center">Monto De Cierre</div></th>
                                                            <th><div align="center">Estado</div></th>

                                                        </tr></thead>
                                                    <?php
                                                    $consul = db_query("select * from vs_aperturaycierre order by idcaja");
                                                    ?>
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                ...
                                                                <td><div align="center"><?php echo $mostrardatos[11] ?></div></td>
