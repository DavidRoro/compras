...
$consulta = db_query("SELECT * FROM pagosfactura where pagosfactura_estado='PENDIENTE'");
if (mysqli_num_rows($consulta) > 0) {
    $tomar = mysqli_fetch_array($consulta);
    $idpag = $tomar[0];
    $combotipo = $tomar[2];
    $txtfechapago = $tomar[4];
    $txtidcuentas = $tomar[5];
    $txtidcompra = $tomar[6];
    $txtsaldo= $tomar[5];
    
} else {
    $datoscompra = db_query("select * from vs_compra where usu_id=$idUsu and com_estado='GENERADO';");
    if ($fila = mysqli_fetch_array($datoscompra)) {
        $txtidcompra = $fila[0];
        $txtnrofact = $fila[2];
    } else {
        $txtidcompra = "SIN FACTURAS";
    }
    $datoscuentabancaria = db_query("select * from cuentas_bancarias where cuentas_bancarias_estado='ACTIVO';");
    if ($filas = mysqli_fetch_array($datoscuentabancaria)) {
        $txtidcuentas = $filas[0];
        $txtsaldo = $filas[4];
    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="pagofactura_abm." enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> DATOS DEL PAGO</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code></code>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-5">
                                            <label><span><i class=""></i>Nro de Factura:</span></label>
                                            <input type="text" name="txtidcompra" value="<?php echo $txtidcompra; ?>" id="ids" class="form-control" readonly="">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-7">
                                            <label><span><i class=""></i>Seleccione Forma de Pago:</span></label>
                                            <select class="form-control" id="tipo_factura" name="pagofactura_tipo">
                                    ...
                                    <div class="form-group"  id="cuenta_bancaria_div">
                                        <div class="col-lg-8">
                                            <label><span><i class=""></i>Cuenta Bancaria:</span></label>
                                            <input type="text" name="txtidcuenta" value="<?php echo $txtidcuentas ?>" id="ids" class="form-control">
                                            <input type="text" name="saldo" id="sucu" value="<?php echo $txtsaldo ?>" class="form-control" readonly="">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>Fecha de Emisión:</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>Fecha de Pago:</span></label>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> DETALLE DEL PAGO</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code></code>
                    ...
                    <script>
                                            ...
                                            var tipoFacturaSelect = document.getElementById("tipo_factura");
                                            var cuentaBancariaDiv = document.getElementById("cuenta_bancaria_div");

                                            tipoFacturaSelect.addEventListener("change", function () {
                                                if (tipoFacturaSelect.value === "CHEQUE") {
                                                    cuentaBancariaDiv.style.display = "block";
                                                } else {
                                                    cuentaBancariaDiv.style.display = "none";
                                                }
                                            });
                    </script>
