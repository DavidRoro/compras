...
$consulta = db_query("SELECT * FROM vs_notacreditoventas where crev_estado='PENDIENTE' and usu_id=$idUsu");
...
$impuestos = db_query("SELECT * FROM det_venta,materia_prima WHERE det_venta.mat_id=materia_prima.mat_id and com_id=$idcom");
    if ($fila = mysqli_fetch_array($impuestos)) {
        $idimpuesto = $fila[12];
    }
} else {
    $datoscompra = db_query("select * from vs_ventas where usu_id=$idUsu and ventas_estado='NO UTILIZADO' OR ventas_estado='GENERADO'");
    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="notacreditoventas_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    ...
                                                    <?php
                                                    $consul = db_query("select * from vs_detnotacreditoventas where crev_id=$idped");
                                                    $iva5 = 0;
                                                    $iva10 = 0;
                                                    $exenta = 0;
                                                    $sumar = 0;
                                                    ...
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                <td><div align="center"><a href="notacreditoventas_abm.php?delete=delete&id=<?php echo $mostrardatos[1] . "&id2=$mostrardatos[0]" ?>"><i class="entypo-trash"></i>Borrar</a></div></td>
