    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="ordenpago_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Datos de Orden de Pago</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Listado de Ordenes de Pago</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                                ...
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><div align="center">Medio de Pago</div></th>
                                                    ...
                                                    <?php
                                                    $consul = db_query("select * from vs_ordenpago order by prv_id");
                                                    ?>
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                ...
                                                                <td><div align="center"><?php echo $mostrardatos[9] ?></div></td> 
