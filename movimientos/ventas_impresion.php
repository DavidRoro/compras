...
$f1 = $_GET['vcod'];
$resultado = db_query("SELECT * FROM vs_ventas WHERE idventa=$f1; ")or die(mysqli_error());
...
$pdf->setY(30);
$pdf->setX(135);
$pdf->Cell(5, $textypos, "RUC: 2465084-6-9");
$pdf->SetFont('Arial', '', 10);
$pdf->setY(35);
$pdf->setX(135);
$pdf->Cell (5, $textypos, "FACTURA VENTA");
$pdf->setY(40);
$pdf->setX(135);
...
//    $pdf->Cell(32, 6, 'ESTADO', 0, 0, 'C', 0);
    ...
    $pdf->Ln(15);
/////////////////////////////
    $resultado2 = db_query("SELECT * FROM vs_detventas where idventa=$row[0]")or die(mysqli_error());
//// Array de Cabecera
