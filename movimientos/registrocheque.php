    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="registrocheque_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Datos del Registro</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            <label><span><i class=""></i>Fecha Cobro:</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9">
                                            ...
                                            ?>
                                            <label><span><i class=""></i>Cheque:</span></label>

                                            <select class="js-example-basic-single form-control" required="" name="cheque">
                                                <option value="">Seleccione:</option>
                                                <?php
                                                $cheque = db_query("select * from cheque order by idcheque");
                                                while ($fila = mysqli_fetch_array($cheque)) {
                                                    ?>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative ">
                                <div class="card-header py-3 bg-info">
                                    <h6 class="m-0 font-weight-bold text-white"><span class="fa fa-archive"></span> Listado de Registros de Cheque</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <code>
                                                ...
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><div align="center">Fecha de Cobro</div></th>

                                                            <th><div align="center">Proveedor</div></th>
                                                            <th><div align="center">Cheque</div></th>                                                           
                                                            <th><div align="center">Estado</div></th>
                                                            <th><div align="center">Acción</div></th>

                                                        </tr></thead>
                                                    <?php
                                                    $consul = db_query("select * from vs_registrocheque order by idregistrocheque");
                                                    ?>
                                                    <tbody>
                                                        <?php while ($mostrardatos = mysqli_fetch_array($consul)) { ?>
                                                            <tr>
                                                                ...
                                                                <td><div align="center"><?php echo "N° 00" . $mostrardatos[5] ?></div></td> 
                                                                <td><div align="center"><?php echo $mostrardatos[1] ?></div></td> 

                                                                <td><div align="center"><button type="button" name="imprimir" id="btn-submit" class="btn btn-primary" onclick="location.href = 'registrocheque_abm.php?imprimir=imprimir&vcod=<?php echo $mostrardatos[0]; ?>'"><span class="fa fa-save"></span></button></div></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
