...
//$idped = $pedido[0];
$consulta = db_query("SELECT * FROM rendicion_gastos where deposito_bancario_estado='PENDIENTE' and usu_id=$idUsu");
    ...
    <body id="page-top" class="bg-gray-100" onLoad="getTime()">
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <form action="rendicion_agregar.php_abm.php" enctype="multipart/form-data" method="POST" role="form">
                    <!-- Page Heading -->
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <div class="col-lg-8">
                                            <label><span><i class=""></i>Cuentas Bancarias:</span></label>

                                            <select class="js-example-basic-single form-control" required="" name="txtidcuentas">
                                                <option value="">Seleccione:</option>
                                                <?php
                                                $cuentas = db_query("select * from cuentas_bancarias order by idcuentas_bancarias");
                                                while ($fila = mysqli_fetch_array($cuentas)) {
                                                    ...
                                                    <option <?= $vcuentas ?> value="<?php echo $fila[0]; ?>"> <?php echo $fila[1]; ?></option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-8">
                                            ...
                                            <select class="js-example-basic-single form-control" required="" name="txtidcheque">
                                                <option value="">Seleccione:</option>
                                                <?php
                                                ...
                                                while ($fila = mysqli_fetch_array($cuentas)) {
                                                    ...
                                                    <option <?= $vcheque ?> value="<?php echo $fila[0]; ?>"> <?php echo $fila[1]; ?></option>
                                                ...
                                                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><div align="center">Cta. Bancaria</div></th>
                                                    ...
                                                    <?php
                                                    $consul = db_query("select * from deposito_bancario");
                                                    ?>
                                                    <tbody>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <a class="btn btn-info" href="_agregar.php">ACEPTAR</a>
                                </div>
                            </div>
                        </div>
                    </div>
