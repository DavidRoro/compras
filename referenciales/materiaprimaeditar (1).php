...
//                                    $consul = "select * from clasificacion order by cla_id;";
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                ...
                                <input type = "submit" name="actualizar" onclick="actualizar();" class="btn btn-success btn-sm" value = "GUARDAR" /> 
                            </div>
                        </div>
                        <?php
                        if (isset($_POST['actualizar'])) {
                            ...
                            $tabla = "materia_prima";
                            edit($tabla, $field, "mat_id", $vcod);
                            echo '<script>location.href="materiaprimalistado.php";</script>';
                        }
//                            else {
