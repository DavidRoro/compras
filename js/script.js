...
{
		var parent = $(this).parent().attr('prueba'+codigo);
	 
	if(confirm('ESTA SEGURO DE ELIMINAR ESTE REGISTRO ?'))
	{


$('#prueba'+codigo).html('<center><img src="./img/loading.gif" width="30" height="30"/></center>');
								
var dataString = 'EliminarUsuario=si&codigo='+btoa(codigo);
