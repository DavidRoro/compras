...
//                $vpresu = $_REQUEST['vcod'];
                ...
                $datos = db_query("SELECT mat_id,mat_descri, mat_precioc FROM materia_prima");
                ?>
                            ...
                            while ($fila = mysqli_fetch_array($datos)) {
                                ...
                                <tbody align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo "<a href=\"javascript:retornar(" . $fila[0] . ",'" . trim($fila[1]). "'," . $fila[2] .");\"> " .
