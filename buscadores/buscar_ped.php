    ...
    <body>
        <div class="container">
            ...
            <center>
                ...
                $datos = db_query("SELECT * FROM det_pedido,materia_prima WHERE det_pedido.mat_id=materia_prima.mat_id and ped_id=$vpresu");
                ?>
                            ...
                            while ($fila = mysqli_fetch_array($datos)) {
                                ...
                                <tbody align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo "<a href=\"javascript:retornar(" . $fila[1] . ",'" . trim($fila[4]) . "'," . $fila[5] . "," . $fila[2] . "," . $fila[7] . ");\"> " .
