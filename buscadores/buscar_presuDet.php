    ...
    <body>
        <div class="container">
            ...
            <center>
                ...
                $datos = db_query("SELECT * FROM det_presupuesto,materia_prima WHERE det_presupuesto.mat_id=materia_prima.mat_id and pre_id=$vpresu");
                ?>
                            ...
                            while ($fila = mysqli_fetch_array($datos)) {
                                ...
                                <tbody align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo "<a href=\"javascript:retornar(" . $fila[1] . ",'" . trim($fila[8]) . "',"  . $fila[2] . "," . $fila[3] . ");\"> " .
